...
{ 
    const char *optstring = "hFDCo:S:E:r:l:t:s:b:m:T:d:I:R";   
    int status = 0;
    int arg, index;
    string cfg_file;
...
// ./test --chr 1 -d 5 -r 40 -m 1000000 -o ./ccc.txt -s 4 -I /data/home/txguo/data_use/maxEnt/parameter_access/radius/rough_chr/1/iter_0/m_1000_r_10/polymer